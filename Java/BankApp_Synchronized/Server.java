...
public class Server extends Thread {
    ...
    public boolean processTransactions(Transactions trans)
    {
        ...
        /* Proces the accounts until the client disconnects */
    ...
    public void run()
    {
        ...
        long serverthread1StartTime, serverThread1EndTime, serverthread2StartTime, serverThread2EndTime;

        String serverIp = Network.getServerIP();

        Network.connect(serverIp);

        //Have 2 threads process the transactions (each keeping track of runtime)
        if(serverThreadId.equals("Thread1"))
        {
            serverthread1StartTime = System.currentTimeMillis();

            processTransactions(trans);


            serverThread1EndTime = System.currentTimeMillis();
            System.out.println(" Terminate Server Thread 1 - Running time: " + (serverThread1EndTime - serverthread1StartTime + " milliseconds"));
        ...
        else
        {
            ...
            serverThread2EndTime = System.currentTimeMillis();
            System.out.println(" Terminate Server Thread 2 - Running time: " + (serverThread2EndTime - serverthread2StartTime + " milliseconds"));
